...
public class CommandInitializer {
    ...
    private void buildCommands() {
        ...
        CommandDescription loginBase = CommandDescription.builder()
            ...
            .detailedDescription("Command to log in using AuthMe.")
        ...
        CommandDescription logoutBase = CommandDescription.builder()
            ...
            .detailedDescription("Command to logout using AuthMe.")
        ...
        CommandDescription registerBase = CommandDescription.builder()
            ...
            .detailedDescription("Command to register using AuthMe.")
        ...
        CommandDescription unregisterBase = CommandDescription.builder()
            ...
            .detailedDescription("Command to unregister using AuthMe.")
        ...
        CommandDescription changePasswordBase = CommandDescription.builder()
            ...
            .detailedDescription("Command to change your password using AuthMe.")
        ...
        CommandDescription captchaBase = CommandDescription.builder()
            ...
            .detailedDescription("Captcha command for AuthMe.")
        ...
        CommandDescription verificationBase = CommandDescription.builder()
            ...
            .detailedDescription("Command to complete the verification process for AuthMe.")
    ...
    private CommandDescription buildAuthMeBaseCommand() {
        ...
        CommandDescription authmeBase = CommandDescription.builder()
            ...
            .detailedDescription("The main AuthMe command. The root for all admin commands.")
        ...
        CommandDescription.builder()
            ...
            .detailedDescription("Purge old AuthMe data longer than the specified number of days ago.")
        ...
        CommandDescription.builder()
            ...
            .detailedDescription("Purge all AuthMe data for banned players.")
        ...
        CommandDescription.builder()
            ...
            .detailedDescription("Reload the AuthMe plugin.")
        ...
        CommandDescription.builder()
            ...
            .detailedDescription("Show detailed information about the installed AuthMe version, the "
        ...
        CommandDescription.builder()
            ...
            .detailedDescription("Converter command for AuthMe.")
    ...
    private CommandDescription buildEmailBaseCommand() {
        ...
        CommandDescription emailBase = CommandDescription.builder()
            ...
            .detailedDescription("The AuthMe email command base.")
